...
INSERT INTO MONSTER (SHOWDOWN_ID, POSITION_X, POSITION_Y, FACING, ACTIVATED_THIS_TURN, LEVEL)
VALUES (100, 11, 6, 'UP', false, 1);

INSERT INTO SURVIVOR (ID, NAME, STATUS, BLEED, ACTIVATIONS_LEFT, MOVES_LEFT, MOVEMENT, SURVIVAL,
            POSITION_X, POSITION_Y, SHOWDOWN_ID)
            VALUES (101, 'Adam', 'STANDING', 0, 1, 1, 5, 0, 0, 1, 100);
INSERT INTO SURVIVOR (ID, NAME, STATUS, BLEED, ACTIVATIONS_LEFT, MOVES_LEFT, MOVEMENT, SURVIVAL,
            POSITION_X, POSITION_Y, SHOWDOWN_ID)
            VALUES (102, 'Eve', 'STANDING', 0, 1, 1, 5, 0, 1, 1, 100);
